...
function power_readToCut() {
  ...
  note.innerHTML = `技術支援網站指引 <a href="./catgory_Study123.html#overlist01">NAS容器如何關閉</a>`;
...
function shoutDownNas() {
  ...
  note.innerHTML = `技術支援網站指引 <a href="./catgory_Study123.html#overlist01">如何關機</a>`;
...
function only() {
  ...
  note.innerHTML = `技術支援網站指引 <a href="./catgory_Study123.html#step5">如何確認學生的帳號密碼?</a>`;
...
function all() {
  ...
  qustion.innerHTML = `
    ...
    `;
  note.innerHTML = `技術支援網站指引 <a href="./catgory_Study123.html#step2">NAS主機怎麼開機</a>`;
...
function canT() {
  ...
  note.innerHTML = `技術支援網站指引 <a href="./catgory_Study123.html#step1">NAS主機怎麼開機</a><a href="https://nds.taipower.com.tw/ndsWeb/ndft112.aspx">台電停電查詢系統</a>`;
...
function dockerOn() {
  ...
  qustion.innerHTML = `
    ...
    `;
  note.innerHTML = `技術支援網站指引 <a href="./catgory_Study123.html#step3">怎麼開啟容器</a>`;
...
function resetSoftware() {
  ...
  note.innerHTML = `技術支援網站指引 <a href="./catgory_Study123.html#step4">如何重新安裝Study123</a>`;
...
function configIP() {
  ...
  note.innerHTML = `技術支援網站指引 <a href="./catgory_Study123.html#step4">如何修改config.txt IP</a>`;
